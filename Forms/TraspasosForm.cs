                            ...
                            try
                            {
                                foreach (DataGridViewRow row in productosDataGridView.Rows)
                                {
                                    ...
                                    if (unidades > 0 || kilos > 0)
                                    {
                                        ...
                                        {
                                            if (!esOrigenCongelados) // Origen Inventario Normal -> Traspaso a Congelados
                                            {
                                            ...
                                            else // Origen Congelados -> Traspaso a Inventario
                                            {
                                                // Descontar de Congelados
                                                var updateCongelados = new SQLiteCommand(@"
                                            UPDATE InventarioCongelados 
                                            SET Unidades = Unidades - @unidades,
                                                Kilos = Kilos - @kilos
                                        ...
                                        {
                                            SucursalOrigenId = esOrigenCongelados ? 3 : 1,
                                            SucursalDestinoId = traspasoCongeladosCheckBox.Checked ? (esOrigenCongelados ? 1 : 3) : 0,
                                            Codigo = codigo,
                                            Unidades = unidades,
                                            Kilos = kilos,
                                        ...
                                        // Aquí podrías agregar la lógica para guardar el traspaso en la base de datos
                                    }
                                }
